...
for i=1:length(patients)
    ...
    % Create CSV files
    writetable(table_train, strcat('F:\Users\user\Desktop\EMORY\Classes\Fall_2021\CS_534\Project\Detection\Extracted_Features_Preprocessing\',patient, '_train.csv'));
    writetable(table_test, strcat('F:\Users\user\Desktop\EMORY\Classes\Fall_2021\CS_534\Project\Detection\Extracted_Features_Preprocessing\',patient, '_test.csv'));
end