...
def cross_validation(X_train, y_train, print_list, subject):
    ...
    # Save AUROC
    fig_dir = os.path.join("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Detection/", "AUROC_"+subject+".png")
    plt.savefig(fig_dir)
    # plt.show()
...
def evaluate_model(X_train, X_test, y_train, y_test, print_list, subject):
    ...
    plot_confusion_matrix(lvqmodel, X_test, y_test, display_labels=("Interictal", "Ictal"), cmap=plt.cm.Blues, normalize="true")

    # Save Confusion Matrix
    fig_dir = os.path.join("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Detection/", "CM_"+subject+".png")
    plt.savefig(fig_dir)
    # plt.show()
...
if __name__ == '__main__':
    ...
    parent_Dir = Path("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Detection/Train/")
    ...
    # Write file
    textfile = open("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Detection/detection_lvq.txt", "w")
    for elem in toprint:
        print(elem)
