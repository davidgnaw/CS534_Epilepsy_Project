...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  9 11:21:09 2021
...
def cross_validation(X_train, y_train, print_list, subject):
    ...
    classifier = classifier = GLVQ(
        distance_type="squared-euclidean",
        activation_type="swish",
        activation_params={"beta": 0.001},
    ...
    # Save AUROC
    fig_dir = os.path.join("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Prediction/", "AUROC_"+subject+".png")
    plt.savefig(fig_dir)
    # plt.show()
...
def evaluate_model(X_train, X_test, y_train, y_test, print_list, subject):
    ...
    auroc = metrics.roc_auc_score(y_test, lvqmodel.predict_proba(X_test)[:,1], average='macro')
    ...
    plot_confusion_matrix(lvqmodel, X_test, y_test, display_labels=("Interictal", "Preictal"), cmap=plt.cm.Blues, normalize="true")

    # Save Confusion Matrix
    fig_dir = os.path.join("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Prediction/", "CM_"+subject+".png")
    plt.savefig(fig_dir)
    # plt.show()
...
if __name__ == '__main__':
    ...
    parent_Dir = Path("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Prediction/Train/")
    ...
    # Write file
    textfile = open("/Users/anu/Desktop/Fall 2021/Machine Learning/project/Prediction/prediction_lvq.txt", "w")
    for elem in toprint:
        print(elem)
